<template>
  <div class="flex-row page">
    <div class="flex-col group_2 space-y-40">
      <div class="flex-col">
        ...
        <div class="flex-row group_4 space-x-8">
          ...
          <span class="font_4 text_11">课程筛选</span>
        </div>
      </div>
...
<!--            <div class="flex-row section_7">-->
            <el-select v-model="form.college" placeholder="请选择学院">
              <el-option label="计算机与计算科学学院" value="compute"></el-option>
              <el-option label="其他学院" value="other"></el-option>
            </el-select>
<!--            </div>-->
          </div>
...
<!--        <div>-->
<!--          <button class="button" @click="filter">筛选</button>-->
<!--        </div>-->
...
<script>
import xuanzekecheng from "@/pages/MyHome/kechengshaixuan/xuanzekecheng/xuanzekecheng";
import footer1 from "@/pages/MyHome/kechengshaixuan/footer1/footer1";
  export default {
    components: {xuanzekecheng,footer1},
    data() {
      return {
        form: {
          grade:'',
