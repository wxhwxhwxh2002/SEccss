  ...
  <div class="flex-col section_2 a1">
    ...
    <div class="flex-col group">
      <div class="flex-row section_3 space-x-80">
        <span class="font_1">添加课程</span>
        <img
          class="image"
          src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/6375a2fc5a7e3f03107db36a/6375a30c993a3600116d6461/16686539561312494619.png"
        />
      </div>
      <div class="flex-col items-start section_4 space-y-43">
        <button class="font_2 text_4 a1" @click="KeChengShaiXuan">课程筛选</button>
        <button class="font_2 text_4 a1" @click="shoudongtianjia">手动添加</button>
        <button class="font_3 text_4 a1" @click="yixuankecheng">已选课程</button>
      </div>
...
<script>
import kechengshaixuan from "@/pages/MyHome/kechengshaixuan/kechengshaixuan";
import shoudongtianjiafangan2 from "@/pages/MyHome/shoudongtianjiafangan2/shoudongtianjia";
